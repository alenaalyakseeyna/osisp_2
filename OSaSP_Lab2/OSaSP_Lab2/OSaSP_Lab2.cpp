...
const wchar_t text[MAX_STRINGS][255] = {
	L"Постой, паровоз, не стучите, колёса,",
	L"Кондуктор, нажми на тормоза.",
	L"Я к маменьке родной с прощальным поклоном",
	L"Спешу показаться на глаза.",
	L"Я к маменьке родной с прощальным поклоном",
	L"Спешу показаться на глаза.",
	L"Назло пышліваму суседу.",
	L"Не жди меня, мама, хорошего сына,",
	L"Твой сын не такой, как был вчера.",
	L"Меня засосала опасная трясина,",
	L"И жизнь моя — вечная игра.",
	L"Меня засосала опасная трясина,",
	L"И жизнь моя — вечная игра.",
	L"А если посадят меня за решётку, в тюрьме я решётку пробью!"
};
